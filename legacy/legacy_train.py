...
from legacy.sandbox_dataset import LocalAudioSandboxDataset
...
def train_model():
    ...
    EPOCHS = 5
    LEARNING_RATE = 0.001
    DATA_DIR = os.path.join("..", "data", "matrices", "legacy")
    ...
    model_save_dir = os.path.join("..", "data", "saved_models", "legacy")
    os.makedirs(model_save_dir, exist_ok = True)
    save_path = os.path.join(model_save_dir, "autoencoder_legacy.pt")
